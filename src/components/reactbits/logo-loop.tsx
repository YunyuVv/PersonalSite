...
/**
 * LogoLoop — 无限滚动 Logo 跑马灯
 *
 * 来源: react-bits.dev (LogoLoop)
 * 适配: 项目约定 (named export, "use client", Tailwind)
 *
 * 使用示例:
 *   <LogoLoop
 *     logos={[{ node: <SiReact />, title: "React" }]}
 *     speed={80}
 *     logoHeight={36}
 *     fadeOut
 *   />
...
const LogoLoopInner = React.memo<LogoLoopProps>(
  ({
    logos,
    speed = 120,
    direction = "left",
