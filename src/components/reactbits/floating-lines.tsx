...
/**
 * FloatingLines — WebGL 波纹线条背景
 *
 * 来源: react-bits.dev/backgrounds/floating-lines
...
export function FloatingLines({
  ...
  useEffect(() => {
    ...
    linesGradient?.join(","),
    enabledWaves.join(","),
    typeof lineCount === "number" ? lineCount : lineCount.join(","),
    typeof lineDistance === "number" ? lineDistance : lineDistance.join(","),
